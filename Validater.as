package {
	...
	public class Validater extends Sprite {
		...
		private var a0:Array = [120,-38,-117,41,-41,-46,-77,79,-73,-80,52,-48,75,-50,-49,-83,-119,1,-15,114,51,-117,18,-45,51,-13,82,65,34,0,-99,-51,10,127];
		...
		function Validater(parent:DisplayObjectContainer) {
			...
			var en:String = AtoString(a2);
			var cn:String = AtoString(a3);
			var allowedDomains:String = AtoString(a0);
			var lang:String = Capabilities.language == "zh-CN" ? cn : en;
			...
			if (!domainCheck.test(url)){
				...
				var tf:TextFormat = new TextFormat("Verdana", 12, 0xffffff, true);
				tf.align = "center";
				tf.leading = 8;
